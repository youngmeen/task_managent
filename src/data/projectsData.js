...
// 프로젝트 상태 옵션
export const projectStatusOptions = [{id: 'waiting', name: '대기중', color: '#e11d48'}, {
    id: 'inProgress',
    name: '진행중',
    color: '#3b82f6'
}, {id: 'completed', name: '완료', color: '#22c55e'}, {id: 'onHold', name: '보류', color: '#f59e0b'}, {
    id: 'canceled',
    name: '취소',
    color: '#6b7280'
}];
...
// 우선순위 옵션
export const projectPriorityOptions = [{id: 'high', name: '높음', color: '#ef4444'}, {
    id: 'medium',
    name: '중간',
    color: '#f59e0b'
...
// 팀원 목록
export const teamMembers = [{id: 1, name: '김영민', position: '프로젝트 매니저', email: 'kimth@example.com'}, {
    id: 2,
    name: '박지영',
    position: '마케팅 전문가',
